...
/* Priority levels for Armada platforms */
#define PLAT_SDEI_CRITICAL_PRI		0x10
#define PLAT_MARVELL_IRQ_PRI		0x30
#define PLAT_SDEI_NORMAL_PRI		0x70

/* Armada platforms use 3 upper bits of secure interrupt priority */
#define MARVELL_PRI_BITS		3

/* SGI used for SDEI signalling */
#define MARVELL_SDEI_SGI		MARVELL_IRQ_SEC_SGI_0

/* ARMADA SDEI dynamic private event numbers */
#define MARVELL_SDEI_DP_EVENT_0		1000
#define MARVELL_SDEI_DP_EVENT_1		1001
#define MARVELL_SDEI_DP_EVENT_2		1002

/* ARMADA SDEI static private event numbers */
#define MARVELL_SDEI_SP_EVENT		1080

/* ARMADA SDEI dynamic shared event numbers */
#define MARVELL_SDEI_DS_EVENT_0		2000
#define MARVELL_SDEI_DS_EVENT_1		2001
#define MARVELL_SDEI_DS_EVENT_2		2002

#define MARVELL_SDEI_PRIVATE_EVENTS \
	SDEI_DEFINE_EVENT_0(MARVELL_SDEI_SGI), \
	SDEI_PRIVATE_EVENT(MARVELL_SDEI_DP_EVENT_0, SDEI_DYN_IRQ, SDEI_MAPF_DYNAMIC), \
	SDEI_PRIVATE_EVENT(MARVELL_SDEI_DP_EVENT_1, SDEI_DYN_IRQ, SDEI_MAPF_DYNAMIC), \
	SDEI_PRIVATE_EVENT(MARVELL_SDEI_DP_EVENT_2, SDEI_DYN_IRQ, SDEI_MAPF_DYNAMIC), \
	SDEI_EXPLICIT_EVENT(MARVELL_SDEI_SP_EVENT, SDEI_MAPF_CRITICAL)

#define MARVELL_SDEI_SHARED_EVENTS \
	SDEI_SHARED_EVENT(MARVELL_SDEI_DS_EVENT_0, SDEI_DYN_IRQ, SDEI_MAPF_DYNAMIC), \
	SDEI_SHARED_EVENT(MARVELL_SDEI_DS_EVENT_1, SDEI_DYN_IRQ, SDEI_MAPF_DYNAMIC), \
	SDEI_SHARED_EVENT(MARVELL_SDEI_DS_EVENT_2, SDEI_DYN_IRQ, SDEI_MAPF_DYNAMIC)


#define PLAT_ARMADA_PRIVATE_SDEI_EVENTS		MARVELL_SDEI_PRIVATE_EVENTS
#define PLAT_ARMADA_SHARED_SDEI_EVENTS		MARVELL_SDEI_SHARED_EVENTS
